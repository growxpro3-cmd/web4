  ...
  return (
    <footer className="relative pt-16 pb-8 px-4" style={{ background: '#060612' }}>
      ...
      <div className="fixed right-2 sm:right-4 md:right-6 bottom-20 sm:bottom-1/4 z-40 flex flex-col gap-2 sm:gap-3">
        <a  href="https://wa.me/919286056937" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
        ...
        <a href="https://t.me/groowxpro" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
        ...
        <a href="https://instagram.com/kartikcommodity" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
