...
const ConnectWithUs = () => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            gsap.fromTo(iconsRef.current.filter(Boolean),
              { scale: 0, opacity: 0 },
  ...
  const socialLinks = [
    ...
    },
    {
      name: 'Instagram',
      color: '#E4405F',
      url: 'https://instagram.com/kartikcommodity',
      icon: (
        <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
    ...
    <section ref={sectionRef} className="relative py-20 px-4"
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-400 mb-12 max-w-xl mx-auto">
          Join our community and stay updated with the latest trading signals
        </p>
